<?php
	...
	if( isset($_GET["coord_x"]) && isset($_GET["coord_y"]) && isset($_GET["niveau"])) {
		...
		if ($mysqli->query('INSERT INTO coordonnees (coord_x, coord_y, niveau) values("'.$coord_x.'", "'.$coord_y.'", "'.$niveau.'")') === TRUE) {
